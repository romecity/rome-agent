    ...
    >
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          >
            <p className="text-sm font-medium text-indigo-500 dark:text-indigo-400 mb-4 tracking-wide uppercase">
        ...
        >
          {capabilities.map((cap, i) => (
            <motion.div
              ...
              className="p-5 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-white/[0.02] hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-colors duration-300"
            >
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {suggestedQuestions.map((q) => (
              <button
                key={q}
                onClick={onStartChat}
                className="px-4 py-2 text-sm rounded-full border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 hover:border-indigo-300 dark:hover:border-indigo-500/40 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all duration-200"
              >
                {q}
              </button>
            ))}
